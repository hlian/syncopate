...
class HomeViewController: UIViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        self.addFaun(SongViewController(song: Song(url: NSURL(string: "https://a.tumblr.com/tumblr_mndqjdrkkq1s1b8mno1_r1.mp3"))))
        self.addFaun(SongViewController(song: Song(url: NSURL(string: "https://a.tumblr.com/tumblr_naqik7VOSl1te74f8o1.mp3"))))

        for i in 0...(self.fauns.count - 1) {
            let songFaun = fauns[i] as SongViewController
            songFaun.view.frame = CGRectMake(10, CGFloat(self.songHeight * i + 10 * (i + 1)), self.view.bounds.size.width - 20, CGFloat(self.songHeight))
